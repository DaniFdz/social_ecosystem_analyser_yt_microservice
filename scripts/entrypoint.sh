...
/root/.local/bin/poetry run python3 -m src.main.python.SocialEcosystemAnalyser.social_ecosystem_analyser_youtube > /root/.logs/yt_service.log 2> /root/.logs/yt_service_error.log
